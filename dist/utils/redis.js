...
exports.parseRedisMonitor = exports.parseRedisNodes = void 0;
...
function parseRedisMonitor(payload) {
    ...
    for (const line of payload.split('\n')) {
        ...
        for (const arg of line.trim().split(' ')) {
            ...
            if (!redisMonitorFields.includes(key))
                continue;
...
exports.parseRedisMonitor = parseRedisMonitor;
